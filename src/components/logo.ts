...
export function starboardLogo(width: number, height: number) {
    return html`<svg width="${width}px" height="${height}px" version="1.1" fill="currentColor" viewBox="0 0 31.954 33.005" xmlns="http://www.w3.org/2000/svg">
